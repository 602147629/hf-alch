...
class CallbackController extends Zend_Controller_Action
{
	...
	public function completepayAction()
	{
        ...
        $secret = APP_SECRET . '&';
        $check = Hapyfish2_Platform_Bll_QqpayByToken::verifySig( 'GET', '/callback/completepay', $params, $secret,$acceptsig);
        if(!$check){
        ...
        $result = Hapyfish2_Platform_Bll_QqpayByToken::completeBuy($userInfo['uid'], $params);
