...
class Hapyfish2_Platform_Cache_Entry_Default_User
{
    ...
    public static function getUser($uid)
    {
        ...
        if ($result === false) {
            if ($cache->isNotFound()) {
                try {
                    $dalUser = Hapyfish2_Platform_Dal_Entry_Default_User::getDefaultInstance();
                    ...
                    info_log('[Hapyfish2_Platform_Cache_User::getUser]:' . $e->getMessage(), 'db.err');
                    return null;
                }
            } else {
                return null;
        ...
        if ($savedb) {
            ...
            if ($ok) {
                try {
                    ...
                    info_log('[Hapyfish2_Platform_Cache_User::updateUser]:' . $e->getMessage(), 'db.err');
                }
            } else {
    ...
    public static function addUser($user)
    {
        ...
        if ($ok) {
            try {
                ...
                info_log('[Hapyfish2_Platform_Cache_User::addUser]:' . $e->getMessage(), 'db.err');
            }
        }
        return $ok;
    }
