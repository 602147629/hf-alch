...
class Hapyfish2_Alchemy_Dal_UniqueItem
{
     ...
     * Single Instance
     *
     * @return Hapyfish2_Alchemy_Dal_UniqueItem
     */
    ...
    public function getTableName($uid)
    {
    	...
    	return 'alchemy_user_unique_item_' . $id;
    }

    public function getInfo($uid)
    {
        $tbname = $this->getTableName($uid);
    	$sql = "SELECT item_ids FROM $tbname WHERE uid=:uid";
