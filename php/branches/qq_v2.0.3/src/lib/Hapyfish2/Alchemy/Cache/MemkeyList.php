...
/**********************************************************************************************/
			...
			'alchemy:bas:buildupgradetips'          	=> 'alchemy:bas:buildupgradetips',
			'alchemy:bas:arenaprize'          			=> 'alchemy:bas:arenaprize',
			
			//酒馆刷新
			'alchemy:bas:hirescorerplist'          		=> 'alchemy:bas:hirescorerplist',
			'alchemy:bas:hirerplist'          			=> 'alchemy:bas:hirerplist',
			
			//地狱塔商店
			'alchemy:bas:HelltowerShop'					=> 'alchemy:bas:HelltowerShop',
			'alchemy:bas:HelltowerConfig'					=> 'alchemy:bas:HelltowerConfig',
			//每日特殊礼包
			'alchemy:bas:SpecialShop'					=>'alchemy:bas:SpecialShop',
			'alchemy:bas:SpecialShopItem'				=>'alchemy:bas:SpecialShopItem',
			
			//聚神点金
			'alchemy:bas:diamodExchangeInfo'				=>'alchemy:bas:diamodExchangeInfo',
