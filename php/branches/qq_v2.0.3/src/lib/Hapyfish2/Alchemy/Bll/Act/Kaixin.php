...
class Hapyfish2_Alchemy_Bll_Act_Kaixin
{
    ...
    public static function get($uid)
	{
        ...
        $livenessTask = array (
        	...
        	'backModuleUrl' => STATIC_HOST . '/'.SWF_VER.'/v2012111401/LivenessTask.swf',
        );
...
//        	}
        ...
        $actState[] = $dailyAct;
         ...
         $trainingCamp = array (
        	...
        	'moduleUrl' => STATIC_HOST . '/'.SWF_VER.'/v2012111201/TrainingCamp.swf',
         );
