...
class Hapyfish2_Alchemy_Bll_Act
{
    ...
    public static function get($uid)
	{
        ...
        $illustrateAct = array (
            ...
            'moduleUrl' => STATIC_HOST . '/'.SWF_VER.'/v2012111601/IllustratedHandbook.swf?v=2012080801'
        );
        ...
        $storageAct = array (
            'actName' => 'storage',
            'moduleUrl' => STATIC_HOST . '/'.SWF_VER.'/v2012110801/storage.swf?v=2012080801'
        );
        $actState[] = $storageAct;
        ...
        $roleInfoAct = array (
            'actName' => 'roleInfo',
            'moduleUrl' => STATIC_HOST . '/'.SWF_VER.'/v2012111401/roleInfo.swf?v=2012080801'
        );
		...
		$dm = array (
        	'actName' => 'DM',
        	'backModuleUrl' => STATIC_HOST . '/'.SWF_VER.'/v2012111402/DM.swf',
        );
		$actState[] = $dm;
		$eventgiftAct = array(
			'actName' => 'GuideGift',
        ...
        $shopAct = array (
        	'actName' => 'shop',
        	'moduleUrl' => STATIC_HOST . '/'.SWF_VER.'/2012110601/shop.swf?v=2012080801'
        );
        $actState[] = $shopAct;
        ...
        $actState[] = $roleWorkAct;
         ...
         $strengthenEquipment = array (
        	...
        	'moduleUrl' => STATIC_HOST . '/'.SWF_VER.'/v2012111501/StrengthenEquipment.swf'
        );
        ...
        $livenessTask = array (
        	...
        	'backModuleUrl' => STATIC_HOST . '/'.SWF_VER.'/v2012111601/LivenessTask.swf',
        );
        $actState[] = $livenessTask;
	     ...
	     $vipDayAward = array (
	        	'actName' => 'VIPEveryDay',
	        	'moduleUrl' => STATIC_HOST . '/'.SWF_VER.'/v2012111401/VIPEveryDay.swf',
	        	'menuUrl'	=> STATIC_HOST . '/'.SWF_VER.'/VIPEveryDayBtn.swf',
...
//        	}
        ...
        $actState[] = $dailyAct;
         ...
         $trainingCamp = array (
        	...
        	'moduleUrl' => STATIC_HOST . '/'.SWF_VER.'/v2012111601/TrainingCamp.swf',
         );
         $actState[] = $trainingCamp;
         $newOrder = array(
				'actName'=>'newOrder',
         		'backModuleUrl'=> STATIC_HOST . '/'.SWF_VER.'/v2012110701/NewOrder.swf',
		);
		 $actState[] = $newOrder;
//         $Helper = array (
//        	'actName' => 'Helper',
...
//		$actState[] = $Helper;
		...
		$treasureBox = array(
			'actName' => 'TreasureBox',
			'backModuleUrl' => STATIC_HOST . '/'.SWF_VER.'/v2012110801/TreasureBox.swf?v=2012080801',
		);
