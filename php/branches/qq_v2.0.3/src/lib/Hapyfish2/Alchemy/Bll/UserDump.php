...
class Hapyfish2_Alchemy_Bll_UserDump
{
    ...
    private static function _recoverAllUserData($uid, $dumpData)
    {
        ...
        try {
	        ...
	        //$story = Hapyfish2_Alchemy_HFC_Story::updateStory($uid, $story);
	        $step++;    //21
	        ...
	        //$story = Hapyfish2_Alchemy_HFC_Story::updateDialog($uid, $storyDialog);
	        $step++;    //22
	        ...
	        Hapyfish2_Alchemy_HFC_Help::updateUnlockFunc($uid, $unlockFunc);
    ...
    private static function _getAllUserData($uid)
    {
        ...
        try {
	        ...
	        Hapyfish2_Alchemy_HFC_Help::update($uid, $help, true);
	        $dalHelp = Hapyfish2_Alchemy_Dal_Help::getDefaultInstance();
	        ...
	        $story = Hapyfish2_Alchemy_HFC_Story::getStory($uid);
	        $newUserStory = array('list' => json_encode($story));
	        Hapyfish2_Alchemy_HFC_Story::updateStory($uid, $newUserStory, true);
	        ...
	        $storyDialog = Hapyfish2_Alchemy_HFC_Story::getDialog($uid);
	        Hapyfish2_Alchemy_HFC_Story::updateDialog($uid, $storyDialog, true);
	        $dal = Hapyfish2_Alchemy_Dal_Story::getDefaultInstance();
