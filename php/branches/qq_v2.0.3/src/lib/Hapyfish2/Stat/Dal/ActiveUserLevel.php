...
class Hapyfish2_Stat_Dal_ActiveUserLevel
{
    protected static $_instance;
    
    private $_tb_day_active_user_level = 'day_active_user_level';
    private $_tb_day_active_user_fight_level = 'day_active_user_fight_level';
    ...
    public function getDayFight($day)
    {
    	$tbname = $this->_tb_day_active_user_fight_level;
    	$sql = "SELECT * FROM $tbname WHERE log_time=:day";
