...
class Hapyfish2_Stat_Bll_Day
{
	...
	public static function getRetention($day)
	{
		$data = null;
		try {
			$dalRetention = Hapyfish2_Stat_Dal_Retention::getDefaultInstance();
	...
	public static function getActiveUserLevel($day)
	{
		$data = null;
		try {
			$dalLevel = Hapyfish2_Stat_Dal_ActiveUserLevel::getDefaultInstance();
	...
	public static function getActiveUserFightLevel($day)
	{
		$data = null;
		try {
			$dalLevel = Hapyfish2_Stat_Dal_ActiveUserLevel::getDefaultInstance();
			$data = $dalLevel->getDayFight($day); 
		} catch (Exception $e) {
	...
	public static function getPayment($day)
	{
		$data = null;
		try {
			$dal = Hapyfish2_Stat_Dal_Payment::getDefaultInstance();
