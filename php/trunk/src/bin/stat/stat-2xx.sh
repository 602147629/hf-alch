...
/usr/bin/wget  -q -O  ${prefix6}-${date1}.log.01   http://192.168.0.40/stat-weibo/${prefix6}-${date1}.log
/usr/bin/wget  -q -O  ${prefix6}-${date1}.log.02   http://192.168.0.41/stat-weibo/${prefix6}-${date1}.log
...
/usr/bin/wget  -q -O  ${prefix7}-${date1}.log.01   http://192.168.0.40/stat-weibo/${prefix7}-${date1}.log
/usr/bin/wget  -q -O  ${prefix7}-${date1}.log.02   http://192.168.0.41/stat-weibo/${prefix7}-${date1}.log
...
/usr/bin/wget  -q -O  ${prefix8}-${date1}.log.01   http://192.168.0.40/stat-weibo/${prefix8}-${date1}.log
/usr/bin/wget  -q -O  ${prefix8}-${date1}.log.02   http://192.168.0.41/stat-weibo/${prefix8}-${date1}.log
...
/usr/bin/wget  -q -O  ${prefix9}-${date1}.log.01   http://192.168.0.40/stat-weibo/${prefix9}-${date1}.log
/usr/bin/wget  -q -O  ${prefix9}-${date1}.log.02   http://192.168.0.41/stat-weibo/${prefix9}-${date1}.log
...
/usr/bin/wget  -q -O  ${prefix10}-${date1}.log.01   http://192.168.0.40/stat-weibo/${prefix10}-${date1}.log
/usr/bin/wget  -q -O  ${prefix10}-${date1}.log.02   http://192.168.0.41/stat-weibo/${prefix10}-${date1}.log
...
/usr/bin/wget  -q -O  ${prefix11}-${date1}.log.01   http://192.168.0.40/stat-weibo/${prefix11}-${date1}.log
/usr/bin/wget  -q -O  ${prefix11}-${date1}.log.02   http://192.168.0.41/stat-weibo/${prefix11}-${date1}.log
...
/usr/bin/wget  -q -O  ${prefix12}-${date1}.log.01   http://192.168.0.40/stat-weibo/${prefix12}-${date1}.log
/usr/bin/wget  -q -O  ${prefix12}-${date1}.log.02   http://192.168.0.41/stat-weibo/${prefix12}-${date1}.log
...
/usr/bin/wget  -q -O  ${prefix13}-${date1}.log.01   http://192.168.0.40/stat-weibo/${prefix13}-${date1}.log
/usr/bin/wget  -q -O  ${prefix13}-${date1}.log.02   http://192.168.0.41/stat-weibo/${prefix13}-${date1}.log
...
/usr/bin/wget  -q -O  ${prefix14}-${date1}.log.01   http://192.168.0.40/stat-weibo/${prefix14}-${date1}.log
/usr/bin/wget  -q -O  ${prefix14}-${date1}.log.02   http://192.168.0.41/stat-weibo/${prefix14}-${date1}.log
...
/usr/bin/wget  -q -O  ${prefix15}-${date1}.log.01   http://192.168.0.40/stat-weibo/${prefix15}-${date1}.log
/usr/bin/wget  -q -O  ${prefix15}-${date1}.log.02   http://192.168.0.41/stat-weibo/${prefix15}-${date1}.log
...
/usr/bin/wget  -q -O  ${prefix16}-${date1}.log.01   http://192.168.0.40/stat-weibo/${prefix16}-${date1}.log
/usr/bin/wget  -q -O  ${prefix16}-${date1}.log.02   http://192.168.0.41/stat-weibo/${prefix16}-${date1}.log
...
/usr/local/php-cgi/bin/php /home/admin/website/alchemy/weibo/bin/stat-2xx.php
