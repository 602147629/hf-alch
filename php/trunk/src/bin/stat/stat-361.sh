...
/usr/bin/wget  -q -O  ${prefix}-${date1}.log.01   http://192.168.0.40/stat-weibo/100-${date1}.log
/usr/bin/wget  -q -O  ${prefix}-${date1}.log.02   http://192.168.0.41/stat-weibo/100-${date1}.log
...
/usr/bin/wget  -q -O  ${prefix}-${date2}.log.01   http://192.168.0.40/stat-weibo/100-${date2}.log
/usr/bin/wget  -q -O  ${prefix}-${date2}.log.02   http://192.168.0.41/stat-weibo/100-${date2}.log
/bin/sort -m -t " " -k 1 -o all-${prefix}-${date2}.log   ${prefix}-${date2}.log.01   ${prefix}-${date2}.log.02  

#to php
cd /home/admin/website/alchemy/weibo/bin
/usr/local/php-cgi/bin/php /home/admin/website/alchemy/weibo/bin/stat-${prefix}.php $1
