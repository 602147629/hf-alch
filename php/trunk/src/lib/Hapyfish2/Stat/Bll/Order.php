...
class Hapyfish2_Stat_Bll_Order
{
    ...
    public static function calOrder($dt, $dir)
    {
        ...
        //$strDate = date('Ymd', $dt);
        $strDate = $dt;
        $fileName311 = $dir. '311/'  . $strDate . '/all-311-' . $strDate . '.log';
        $fileName312 = $dir. '312/'  . $strDate . '/all-312-' . $strDate . '.log';
        $fileName313 = $dir. '313/'  . $strDate . '/all-313-' . $strDate . '.log';
        $fileName314 = $dir. '314/'  . $strDate . '/all-314-' . $strDate . '.log';
        ...
        try {
            ...
            $params312 = array();
            $params312[] = array('addCoin', 4, array('group'=>0,'sum'=>1,'avg'=>0,'diff'=>0));
