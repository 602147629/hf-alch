...
class Hapyfish2_Alchemy_Bll_Editstory
{
    ...
    //进入副本地图
    public static function enterMap($uid, $mapId, $portalId=null, $storyId=null)
	{
	    if (strlen($mapId)<3) {
	        //return -301;
	    }
			...
			//玩家属性
				...
				if ($v['id'] == 'coin') {
					...
					if ($userCoin < $v['num']) {
						...
						Hapyfish2_Alchemy_HFC_User::decUserCoin($uid, $v['num'],35);
						$coinChange -= $v['num'];
					}
				}
				else if ($v['id'] == 'sp') {
