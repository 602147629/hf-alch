...
class WatchController extends Zend_Controller_Action
{
    ...
    public function indexAction()
    {
        ...
        $this->view->devtype = APP_SERVER_TYPE;
        ...
        $timestamp = time();
        $wUid = 100000000 + $uid;
        $ticket = md5($wUid . $platfromUser['name'] . $timestamp . CHAT_SECRET);
        $this->view->chatUser = array(
            'uid' => $wUid, 'name' => $platfromUser['name'], 'timestamp' => $timestamp, 'ticket' => $ticket
        );
