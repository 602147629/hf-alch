...
class HelltowerController extends Hapyfish2_Controller_Action_Api
{
    ...
    public function finishwatersweepAction()
    {
        ...
        $status = Hapyfish2_Alchemy_Bll_Helltower::finishWaterSweep($uid);
    ...
    {
    	$uid = $this->uid;
        $status = Hapyfish2_Alchemy_Bll_Helltower::revivalWaterDungeon($uid);
    ...
    {
    	$uid = $this->uid;
        $status = Hapyfish2_Alchemy_Bll_Helltower::revivalAbyssDungeon($uid);
