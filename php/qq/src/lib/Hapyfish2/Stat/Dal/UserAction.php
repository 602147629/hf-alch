...
class Hapyfish2_Stat_Dal_UserAction
{
    ...
    private $_tbHourName = 'day_user_action_hour';
...
/********************* 以下为小时数据 ****************************/
    ...
    public function getHourRow($day)
    {
    	$tbname = $this->_tbHourName;
    	$sql = "SELECT * FROM $tbname WHERE log_time=:day";
    ...
    public function listHourData($dtBegin, $dtEnd)
    {
    	$tbname = $this->_tbHourName;
    	$sql = "SELECT * FROM $tbname WHERE log_time>=:dtBegin AND log_time<=:dtEnd";
    ...
    public function insertHour($info)
    {
    	$tbname = $this->_tbHourName;
    	$db = Hapyfish2_Db_FactoryStat::getStatLogDB();
    	$wdb = $db['w'];
    ...
    public function deleteHour($day)
    {
    	$tbname = $this->_tbHourName;
    	$db = Hapyfish2_Db_FactoryStat::getStatLogDB();
    	$wdb = $db['w'];
