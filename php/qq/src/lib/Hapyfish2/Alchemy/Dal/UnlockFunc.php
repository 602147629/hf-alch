...
class Hapyfish2_Alchemy_Dal_UnlockFunc
{
    ...
    public function init($uid)
    {
        ...
        $sql = "INSERT INTO $tbname(`uid`,`func_list`) 
        		VALUES(:uid, 'order,diy,roleInfo,worldMap,roleWork,roleInfoSkill,roleInfoTrain,hire,fix,heal,strengthen,arena,mix,buildingLvUp,trainingCamp,occ,formation,popUpUisprite,TreasureBox,goHome,goVillage')";
