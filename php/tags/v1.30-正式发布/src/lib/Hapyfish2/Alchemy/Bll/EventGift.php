...
//		return array('day'=>$id, 'type'=>-1, 'time'=>$time);
	...
	{
		$dal = Hapyfish2_Alchemy_Dal_InviteLog::getDefaultInstance();
		$count = $dal->getCount($uid);
		...
		$award[] = array(
			'count'=>3,
			'list'=>array($cid,1,4415,2,4515,2)
		);
		$award[] = array(
			'count'=>8,
			'list'=>array(11362,1,4415,3,4515,3)
		);
		$award[] = array(
			'count'=>15,
			'list'=>array(11464,1,4415,5,4515,5)
		);
