...
//		$resultInitVo['autoUseList'] = self::getAutoList();
	...
	public static function getGameData()
	{
		...
		$info['wineCid'] = 1115;
		$info['needWineNum'] = 1;
		$info['skillUnlock'] = json_decode('[[0,1,0],[5,1,500],[15,1,5000],[0,2,10]]');
	...
	public static function getInitSpecialUpgrade()
	{
		...
		$resultVo['SpecialUpgradeVo'] = array_merge($homeLevel, $tavernLevel, $smithyLevel);
