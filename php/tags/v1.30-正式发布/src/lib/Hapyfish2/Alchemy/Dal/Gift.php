...
class Hapyfish2_Alchemy_Dal_Gift
{
     ...
     * Single Instance
     *
     * @return Hapyfish2_Alchemy_Dal_Gift
     */
    ...
    public function getTableNameBag($uid)
    {
    	...
    	return 'alchemy_user_gift_bag_' . $id;
    }
    ...
    public function getTableNameWish($uid)
    {
    	...
    	return 'alchemy_user_gift_wish_' . $id;
    }
    ...
    public function getTableNameFriendWish($uid)
    {
    	...
    	return 'alchemy_user_gift_friend_wish_' . $id;
    }


    /* basic db table
   	update alchemy_gift g , alchemy_building b set g.name=b.name,g.class_name=b.class_name where g.gid=b.id and g.type=2;
	update alchemy_gift g , alchemy_item i set g.name=i.name,g.class_name=i.class_name where g.gid=i.id and g.type=1;
    */
    //
    public function getBasicGiftList()
    {
        ...
        $rdb = $db['r'];
    	$sql = "SELECT * FROM alchemy_gift ORDER BY sort";
