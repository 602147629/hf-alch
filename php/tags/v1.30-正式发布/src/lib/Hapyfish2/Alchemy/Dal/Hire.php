...
class Hapyfish2_Alchemy_Dal_Hire
{
    ...
    public function get($uid)
    {
    	...
    	$sql = "SELECT hire_1,hire_2,hire_3,hire_4,hire_5,hire_6 FROM $tbname WHERE uid=:uid";
    ...
    {
        $tbname = $this->getTableName($uid);
        $sql = "INSERT INTO $tbname(uid, `hire_1`, `hire_2`, `hire_3`, `hire_4`, `hire_5`, `hire_6`) 
        		VALUES(:uid, '[1,1,1]', '[2,1,1]', '[3,2,1]', '[4,2,1]', '[5,3,1]', '[6,3,1]')";
        $db = Hapyfish2_Db_Factory::getDB($uid);
        $wdb = $db['w'];
