    ...
    'name'	    => 'line'
	    ...
	    $list['alchemy_goods'] = array(
			...
			'column'	=> array('cid'=>'cid', 'type'=>'type', 'func_id'=>'物品作用cid', 'name'=>'name', 'tips'=>'tips', 'content'=>'content',
								 ...
								 'buy_gem'=>'buy_gem', 'sale_coin'=>'售系统价格', 'worth'=>'售顾客价格', 'lose'=>'是否消耗(1消耗)', 'label'=>'label', 'buy_level'=>'购买需要等级', 'sort'=>'排序','useLevel'=>'使用等级','isGift'=>'是否为礼包')
		);
	    ...
	    $list['alchemy_scroll'] = array(
			...
			'column'	=> array('cid'=>'cid', 'mix_cid'=>'合成术cid', 'jobs'=>'职业列表', 'type'=>'type', 'element'=>'element', 'name'=>'name', 'content'=>'content',
								 ...
								 'probability'=>'权重', 'hire_type'=>'hire_type', 'hire_level'=>'hire_level', 'rp'=>'rp', 'study_level'=>'study_level')
		);
	    ...
	    $list['alchemy_mercenary_card'] = array(
			...
			'column'	=> array('cid'=>'cid', 'type'=>'type', 'func_id'=>'物品作用cid', 'name'=>'name', 'tips'=>'tips', 'content'=>'content',
								 'class_name'=>'class_name', 'is_new'=>'is_new', 'can_buy'=>'can_buy', 'buy_coin'=>'buy_coin',
								 'buy_gem'=>'buy_gem', 'sale_coin'=>'售系统价格', 'worth'=>'售顾客价格', 'lose'=>'是否消耗(1消耗)', 'label'=>'label', 'buy_level'=>'购买需要等级', 'sort'=>'排序','useLevel'=>'使用等级',
...
$list['line_5'] = array(
    ...
    'name'	    => 'line'
	    ...
	    $list['alchemy_mercenary_rp_rand'] = array(
	    		...
	    		'key'		=> 'rp',
	    		'column'	=> array('rp'=>'rp', 'pro1'=>'pro1', 'pro2'=>'pro2', 'pro3'=>'pro3', 'pro4'=>'pro4', 'pro5'=>'pro5', 
