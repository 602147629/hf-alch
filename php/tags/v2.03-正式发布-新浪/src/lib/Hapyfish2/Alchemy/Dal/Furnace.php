...
class Hapyfish2_Alchemy_Dal_Furnace
{
    ...
    public function getAll($uid)
    {
    	...
    	$sql = "SELECT id,furnace_id,x,z,m,cid,start_time,need_time,cur_probability,num,status,idx FROM $tbname WHERE uid=:uid";
    ...
    {
        $tbname = $this->getTableName($uid);
        $sql = "SELECT id,furnace_id,x,z,m,cid,start_time,need_time,cur_probability,num,status,idx FROM $tbname WHERE id=:id AND uid=:uid";
