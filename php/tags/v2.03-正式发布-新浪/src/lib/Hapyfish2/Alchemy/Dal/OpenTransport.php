...
class Hapyfish2_Alchemy_Dal_OpenTransport
{
     ...
     * Single Instance
     *
     * @return Hapyfish2_Alchemy_Dal_OpenTransport
     */
    ...
    public function getTableName($uid)
    {
    	...
    	return 'alchemy_user_map_copy_transport_' . $id;
    }
    ...
    public function insUpd($uid, $info)
    {
        ...
        $sql = "INSERT INTO $tbname (uid, `list`)
        		VALUES (:uid, :list)
        		ON DUPLICATE KEY UPDATE `list`=:list";

        return $wdb->query($sql, array('uid'=>$uid, 'list'=>$info['list']));
    }
