...
class Hapyfish2_Application_SinaWeibo extends Hapyfish2_Application_Abstract
{
    ...
    {
        $sessionKey = $_REQUEST[OpenApi_SinaWeibo_Weiyouxi::PREFIX_PARAM.'session_key'];

        $puid = $_REQUEST[OpenApi_SinaWeibo_Weiyouxi::PREFIX_PARAM.'user_id'];
        $signature = $_REQUEST[OpenApi_SinaWeibo_Weiyouxi::PREFIX_PARAM.'signature'];
        if (empty($sessionKey)) {
        ...
        try {
            $this->_rest = OpenApi_SinaWeibo_Client::getInstance();
