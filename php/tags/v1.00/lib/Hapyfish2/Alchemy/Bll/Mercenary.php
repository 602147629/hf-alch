...
class Hapyfish2_Alchemy_Bll_Mercenary
{
	public static function setHireOpened($uid, $id)
	{
		...
		if ( !$hire['cid'] ) {
			$newHire = self::getNewHire($uid, $id, $hire);
	...
	public static function getHire($uid)
	{
		...
		foreach ( $hireList as $hire ) {
			...
			/*$list[] = array('id' => $hire['id'],
						    'price' => $hire['coin'],
						    'remainingTime' => $hire['remainingTime'],
	...
	public static function hireMercenary($uid, $id, $npcId)
	{
		...
		$info = array(
            ...
            'skill' => json_decode($growInfo['skill']),
            'weapon' => array()
	    );
...
/********************/
	...
	public static function getRandModelWithName($modelInfo, $userNameList, $maxCount, $job, $hire)
	{
		...
		foreach ( $modelAllList as $kModel => $vModel ) {
			if ( !in_array($hire['type'], $modelHireType) || $hire['level'] < $vModel['hire_level'] ) {
	...
	{
		$randArray = array(
						'1' => array('pro1' => 80, 'pro2' => 95, 'pro3' => 100, 'pro4' => 0, 'pro5' => 0),
						'2' => array('pro1' => 78, 'pro2' => 92, 'pro3' => 97, 'pro4' => 99, 'pro5' => 100),
						'3' => array('pro1' => 78, 'pro2' => 92, 'pro3' => 97, 'pro4' => 99, 'pro5' => 100),
						'4' => array('pro1' => 78, 'pro2' => 92, 'pro3' => 97, 'pro4' => 99, 'pro5' => 100),
						'5' => array('pro1' => 78, 'pro2' => 92, 'pro3' => 97, 'pro4' => 99, 'pro5' => 100)
					);
