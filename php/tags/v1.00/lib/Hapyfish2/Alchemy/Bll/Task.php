...
class Hapyfish2_Alchemy_Bll_Task
{
    ...
    private static $_taskTypeLogicMap = array(
                ...
                16 => 16,
                17 => 17, 27 => 17,
                18 => 18, 28 => 18, 29 => 18, 30 => 18, 31 => 18, 32 => 18, 33 => 18, 34 => 18,
                19 => 19,
                20 => 20,
                21 => 21,
                23 => 23
    ...
    public static function triggerStory($uid, $id)
    {
        //准备npc剧情/对白
        if ($id) {
            //info_log($uid.'|'.$id, 'ccc');
	...
	public static function getDailyTask($uid)
	{
        ...
        if ( !$taskDaily['refresh_tm'] || date('Ymd',$taskDaily['refresh_tm'])!=date('Ymd',$nowTm) ) {
