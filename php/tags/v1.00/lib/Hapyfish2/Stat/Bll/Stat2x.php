...
class Hapyfish2_Stat_Bll_Stat2x
{
    ...
    public static function calcFight($dt, $dir='/home/admin/logs/alchemy/renren/')
    {
        $strDate = $dt;
    ...
    private static function _getEnterCopy($dt, $dir)
    {
    	...
    	$num = 0;
    	$pnum = 0;
        $fileName = $dir . $dt . '/all-220-' . $dt . '.log';
        try {
            //file not exists
    ...
    private static function _getMonster($dt, $dir)
    {
      $data = array();
    	$num = 0;
    	$pnum = 0;
        $fileName = $dir . $dt . '/all-221-' . $dt . '.log';
        try {
            //file not exists
            if (!file_exists($fileName)) {
                info_log($fileName . ' not exists!', 'stat_DaycLoadTm');
 	...
 	private static function _getBoss($dt, $dir)
    {
      $data = array();
    	$num = 0;
    	$pnum = 0;
        $fileName = $dir . $dt . '/all-222-' . $dt . '.log';
        try {
            //file not exists
            if (!file_exists($fileName)) {
                info_log($fileName . ' not exists!', 'stat_DaycLoadTm');
	...
	private static function _getMater($dt, $dir)
    {
      $data = array();
    	$num = 0;
    	$pnum = 0;
        $fileName = $dir . $dt . '/all-223-' . $dt . '.log';
        try {
            //file not exists
            if (!file_exists($fileName)) {
                info_log($fileName . ' not exists!', 'stat_DaycLoadTm');
    ...
    public static function calcMutual($dt,$dir ='/home/admin/logs/alchemy/renren/')
    {
    	$help = self::_getHelp($dt, $dir);
	...
	private static function _getHelp($dt, $dir)
    {
    	...
    	$num = 0;
    	$pnum = 0;
        $fileName = $dir . $dt . '/all-225-' . $dt . '.log';
        try {
            //file not exists
            if (!file_exists($fileName)) {
                info_log($fileName . ' not exists!', 'stat_DaycLoadTm');
	...
	private static function _getSeize($dt, $dir)
    {
    	...
    	$num = 0;
    	$pnum = 0;
        $fileName = $dir . $dt . '/all-226-' . $dt . '.log';
        try {
            //file not exists
            if (!file_exists($fileName)) {
                info_log($fileName . ' not exists!', 'stat_DaycLoadTm');
	...
	private static function _getResist($dt, $dir)
    {
    	...
    	$num = 0;
    	$pnum = 0;
        $fileName = $dir . $dt . '/all-227-' . $dt . '.log';
        try {
            //file not exists
            if (!file_exists($fileName)) {
                info_log($fileName . ' not exists!', 'stat_DaycLoadTm');
	...
	private static function _getGift($dt, $dir)
    {
    	...
    	$num = 0;
    	$pnum = 0;
        $fileName = $dir . $dt . '/all-228-' . $dt . '.log';
        try {
            //file not exists
            if (!file_exists($fileName)) {
                info_log($fileName . ' not exists!', 'stat_DaycLoadTm');
    ...
    public static function calcRepair($dt,$dir ='/home/admin/logs/alchemy/renren/')
    {
		$data = array();
    	$num = 0;
    	$pnum = 0;
        $fileName = $dir . $dt . '/all-229-' . $dt . '.log';
        try {
            //file not exists
            if (!file_exists($fileName)) {
                info_log($fileName . ' not exists!', 'stat_DaycLoadTm');
