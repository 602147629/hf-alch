...
class Hapyfish2_Stat_Bll_Mercenary
{
    ...
    public static function calHireMercenary($dt, $dir)
    {
        ...
        //$strDate = date('Ymd', $dt);
        $strDate = $dt;
        $fileName301 = $dir . $strDate . '/all-301-' . $strDate . '.log';
        $fileName302 = $dir . $strDate . '/all-302-' . $strDate . '.log';
        $fileName303 = $dir . $strDate . '/all-303-' . $strDate . '.log';
        $fileName304 = $dir . $strDate . '/all-304-' . $strDate . '.log';
        $fileName305 = $dir . $strDate . '/all-305-' . $strDate . '.log';
        try {
            ...
            $params301[] = array('coin', 5, array('group'=>0,'sum'=>1,'avg'=>0,'diff'=>0));
