package happyfish.actModule.giftGetAct.view.current 
{
	...
	public class CurrentItemView extends GridItem
	{
		...
		{  
			...
			var str:String = LocaleWords.getInstance().getWord("GiftGetActword2") + GiftDomain.getInstance().getFriendUserVo(frienduid).name + LocaleWords.getInstance().getWord("GiftGetActword3");
