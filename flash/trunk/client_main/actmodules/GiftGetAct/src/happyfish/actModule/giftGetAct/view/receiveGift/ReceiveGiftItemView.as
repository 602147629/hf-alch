package happyfish.actModule.giftGetAct.view.receiveGift 
{
	...
	public class ReceiveGiftItemView extends GridItem
	{
		...
		override public function setData(value:Object):void
		{
			...
			iview.nametxt.text = LocaleWords.getInstance().getWord("GiftGetActword10") + GiftDomain.getInstance().getFriendUserVo(data.uid).name + LocaleWords.getInstance().getWord("GiftGetActword16");
