		...
		private function clickFun(e:MouseEvent):void 
		{
			switch (e.target) 
			{
				...
				case _iview.goDoorBtn:
					var curScene:SceneClassVo = DataManager.getInstance().getSceneClassById(DataManager.getInstance().currentUser.currentSceneId);
					if (curScene.parentSceneId) 
					{
						new MoveSceneCommand().moveScene(curScene.parentSceneId);
					}else {
