...
/*			//退出编辑模式
		...
		public function playBgMusic():void {
			...
			if (sceneClass.bgSound) 
			{
				...
				BgMusicManager.getInstance().setSound(InterfaceURLManager.getInstance().staticHost+"bgm01.mp3?v=20111221v1");
			}
		}
		...
		{
			var fogData:ByteArray = DataManager.getInstance().getLocalFogData();
