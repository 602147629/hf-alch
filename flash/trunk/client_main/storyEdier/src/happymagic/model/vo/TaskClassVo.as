package happymagic.model.vo 
{
	...
	public class TaskClassVo extends BasicVo
	{
		...
		public var sceneId:Array=new Array();
		public var npcId:uint;
		public var finishSceneId:Array = new Array();
		...
		{
			if (obj.sceneId is Number) 
			{
				obj.sceneId = [obj.sceneId];
			}
			
			if (obj.finishSceneId is Number) 
			{
				obj.finishSceneId = [obj.finishSceneId];
			}
