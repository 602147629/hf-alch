package happyfish.display.ui.defaultList 
{
	...
	{
		public function DefaultVLineListView(uiview:Sprite,_container:DisplayObjectContainer,_pageLength:uint,_hideButton:Boolean=false,_autoAlginButton:Boolean=true) 
		{
