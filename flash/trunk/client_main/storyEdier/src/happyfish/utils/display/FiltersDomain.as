package happyfish.utils.display 
{
	...
	public class FiltersDomain
	{
		...
		public static function get redGlow():GlowFilter {
			if (!redGlowFilter) 
			{
				redGlowFilter=new GlowFilter(0xff0000, 1, 8, 8, 2, 1,true);
			}
		...
		public static function get yellowGlow():GlowFilter {
			if (!yellowGlowFilter) 
			{
				yellowGlowFilter=new GlowFilter(16776960, 1, 4, 4, 10, 1, false, false);
			}
		...
		public static function get blueGlow():GlowFilter {
			if (!blueGlowFilter) 
			{
				blueGlowFilter=new GlowFilter(0x1F5795, 1, 4, 4, 2, 1,true);
			}
