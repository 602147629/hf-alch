package happyfish.scene.astar
{
	...
	public class NodesUtil
	{
		 ...
		 * @return
		 */
		public static function getAroundNodesByRect(rect:Rectangle):Array
		{
			var arr:Array = new Array();
			if (rect == null)
			{
			...
			for (var i:int = 0; i < width; i++) 
			{
				...
				{
					if (m == 0 || m == (height - 1) || i == 0  || i == (width - 1))
					{
						arr.push(new Node(left + i, top + m));
					}
				}
			}
			return arr;
		...
		public static function equalsPos(node1:Node, node2:Node):Boolean
		{
