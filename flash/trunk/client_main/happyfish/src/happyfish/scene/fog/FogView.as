package happyfish.scene.fog
{
	...
	public class FogView extends Bitmap
	{
		...
		private var ellipseRect:Rectangle;
		...
		public function FogView(scenePic:BitmapData, color:int, alpha:Number, nodeSize:int)
		{
			...
			ellipse = new FogMask(500,241);
			ellipseRect =  new Rectangle(0, 0, ellipse.width, ellipse.height);
		...
		private function dissipate(node:FogNode):void
		{
			...
			bitmapData.threshold(ellipse, ellipseRect, new Point(screenX, screenY), "<", 0x7F000000);
		}
