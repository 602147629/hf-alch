package happymagic.display.view.maininfo 
{
	...
	public class MainInfoView extends UISprite
	{
		...
		private function clickFun(e:MouseEvent):void 
		{
			...
			{
				case iview.addSpBtn:
					//DataManager.getInstance().curSceneUser.viliageInfo[1269] = 2;
					//(DataManager.getInstance().worldState.world as MagicWorld).refreshSpecialBuild(1269);
				break;
		...
		public function getValuePosition(valueType:uint):Point {
			...
			switch (valueType) 
			{
			    ...
			    case PiaoMsgType.TYPE_ITEM:
				    p = menuview.getBtnPoint("itemboxBtn");
					return p;
				break;
				
			    case PiaoMsgType.TYPE_BATTLE_EXP:
				    p = menuview.getBtnPoint("roleInfoBtn");
					return p;
				break;	
