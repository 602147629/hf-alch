package happymagic.model.command 
{
	...
	public class initCommand extends BaseDataCommand
	{
		...
		override protected function load_complete(e:Event):void 
		{
			...
			// 功能锁定
			if (objdata.user.funcLocks)
			{
				DataManager.getInstance().functionFilterData.setLockList(objdata.user.funcLocks);
			}
			...
			if (objdata.autoUseList)
			{
				tmdm.itemData.autoUseInitList = objdata.autoUseList;
			}
